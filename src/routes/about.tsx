      ...
      <section className="px-6 md:px-8 max-w-5xl mx-auto grid md:grid-cols-[1fr_320px] gap-12 pb-24">
        <div className="space-y-6 text-lg leading-relaxed text-foreground/90">
          ...
          <p>
            ...
            Geräusch eines fremden Dialekts, das Licht, das fünf Minuten später wieder weg ist.
            Daraus mache ich Bilder und kurze Texte. Keine Top-10-Listen.
          </p>
          <p>
            Wenn du selbst los willst und nicht weißt, wo du anfangen sollst — schreib mir. Ich
            antworte auf jede Mail, manchmal langsam, aber immer.
          </p>
        </div>
        <div>
