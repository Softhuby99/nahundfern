  ...
  return (
    <div className="min-h-screen bg-background text-foreground flex flex-col">
      ...
      <section className="px-6 md:px-8 pt-16 pb-24 max-w-3xl mx-auto w-full flex-1">
        ...
        <h1 className="font-display text-5xl md:text-7xl tracking-tight font-light leading-[1.05] mb-8">Schreib mir.</h1>
        ...
        {sent ? (
          <div className="border border-primary p-8 bg-card rounded-sm">
            <p className="font-mono text-[10px] uppercase tracking-widest text-primary mb-2">Sent</p>
            <p className="font-display text-3xl tracking-tight font-medium">Danke. Bis bald.</p>
          </div>
        ) : (
          <form
            onSubmit={(e) => {
          ...
          >
            ...
            <div>
              ...
              <textarea
                ...
                rows={6}
                required
                className="w-full bg-card border border-border focus:border-primary focus:outline-none p-3 text-foreground transition-colors rounded-sm"
              />
            </div>
            <button
              type="submit"
              className="px-6 py-3 bg-primary text-primary-foreground font-mono text-[10px] tracking-widest uppercase hover:bg-primary/90 transition-colors rounded-sm"
            >
              Senden →
            </button>
