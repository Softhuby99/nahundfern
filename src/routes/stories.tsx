      ...
      <section className="px-6 md:px-8 pb-24 max-w-7xl mx-auto grid md:grid-cols-2 lg:grid-cols-3 gap-10">
        {trips.map((t: PublicTrip) => (
          <Link key={t.slug} to="/stories/$slug" params={{ slug: t.slug }} className="group">
            <div className="overflow-hidden aspect-[4/5] mb-4 bg-card rounded-sm">
              <ResponsivePicture
                webp={t.cover.webp}
                avif={t.cover.avif}
            ...
            <h2 className="font-display text-2xl md:text-3xl tracking-tight font-medium group-hover:text-primary transition-colors">{t.title}</h2>
