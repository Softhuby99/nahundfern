...
const TRIPS = [
  {
    ...
    endDate: "2024-05-12",
    file: "trip-lisbon.jpg",
    excerpt:
      "Acht Tage zwischen Azulejos, gelben Trams und dem warmen Wind, der den Tejo hochzieht.",
    body: [
      ...
      "Tipp: Geh nicht in die Pastéis-Schlange im Zentrum. Geh stattdessen nach Belém, früh, mit einem Espresso.",
    ],
  },
  {
    slug: "geiranger",
    ...
    endDate: "2024-06-20",
    file: "trip-fjords.jpg",
    excerpt:
      "Zwölf Tage Stille zwischen Granit und Nebel. Manchmal hört man eine Möwe, manchmal nur sich selbst.",
    body: [
      ...
      "Ich habe in einer alten Berghütte über Eidsdal gewohnt. Kein WLAN, kein Empfang, ein Holzofen.",
      "Praktisch: Miete dir kein Auto am Flughafen Ålesund — nimm den Bus bis Geiranger und das Schiff ab dort.",
    ],
  },
  {
    slug: "val-dorcia",
    ...
    endDate: "2024-07-16",
    file: "trip-tuscany.jpg",
    excerpt:
      "Sanfte Hügel, Zypressenalleen und ein Licht, das jeden Sonnenuntergang zu einem Gemälde macht.",
    body: [
      "Die Toskana ist genau so kitschig, wie alle sagen — und genau so schön.",
      "In Pienza haben wir den besten Pecorino unseres Lebens gegessen.",
      "Geheimtipp: Steh um 5 auf, fahr nach San Quirico, parke neben der Cappella della Madonna di Vitaleta.",
    ],
  },
  {
    slug: "black-sands",
    ...
    endDate: "2024-08-17",
    file: "trip-iceland.jpg",
    excerpt:
      "Schwarzer Sand, basaltschwarze Klippen, weißes Meer. Island spielt nur mit drei Farben — aber laut.",
    body: [
      "Reynisfjara ist ein Strand, an dem du nicht baden willst.",
      "Ich habe vierzehn Tage lang die Ringstraße im Uhrzeigersinn abgefahren.",
      "Was du brauchst: regenfeste Hose, echte Wanderschuhe, eine warme Mütze — auch im August.",
    ],
  },
  {
    ...
    file: "trip-nyc.jpg",
    excerpt:
      "Sieben Tage zwischen Dampf, Yellow Cabs und der Frage, wie viele Pizzen ein Mensch verträgt.",
    body: [
      "New York ist laut. New York ist müde. New York ist absurd schön um sieben Uhr morgens.",
      "Wir haben uns drei Tage lang nur durch Brooklyn gegessen.",
      "Tipp: Nimm die Staten Island Ferry nach Sonnenuntergang.",
    ],
  },
  {
    slug: "rocky-mirror",
    ...
    file: "trip-banff.jpg",
    excerpt:
      "Türkises Wasser unter grauen Wolken — die kanadischen Rockies haben uns dreimal stehenbleiben lassen.",
    body: [
      "Lake Moraine im Oktober: keine Touristenbusse mehr, dafür Schnee an den Hängen.",
      "Wir haben in einer kleinen Lodge in Canmore gewohnt.",
      "Wichtig: Bär-Spray dabeihaben. Wirklich.",
    ],
  },
  {
    slug: "route-66",
    ...
    endDate: "2024-11-18",
    file: "trip-route66.jpg",
    excerpt:
      "Sechzehn Tage Asphalt, Neon und Motels, in denen die Klimaanlage lauter ist als die Gespräche.",
    body: [
      "Route 66 ist nicht mehr die echte Route 66.",
      "Wir haben in Seligman gehalten, in Oatman, in Amboy.",
      "Praktisch: kein Cabrio. Klingt romantisch, ist es nicht.",
    ],
  },
  {
    ...
    endDate: "2024-12-13",
    file: "trip-yellowstone.jpg",
    excerpt: "Geysire im Schnee, Bisons im Nebel, –22 °C beim Frühstück.",
    body: [
      "Im Winter ist Yellowstone ein anderer Planet.",
      "Old Faithful im Schneetreiben ist eine Sache, die du gesehen haben musst.",
      "Tipp: Buche die Snow Lodge ein halbes Jahr vorher.",
    ],
  },
];
...
for (const t of TRIPS) {
  ...
  try {
    ...
    console.warn(`seed: asset missing ${src}, skip`);
    continue;
  }
